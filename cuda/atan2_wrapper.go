...
// CUDA handle for pw_atan2 kernel
var pw_atan2_code cu.Function
...
// Stores the arguments for pw_atan2 kernel invocation
var pw_atan2_args pw_atan2_args_t
...
func k_pw_atan2_async ( dst unsafe.Pointer, y unsafe.Pointer, x unsafe.Pointer, N int,  cfg *config) {
	...
	pw_atan2_args.Lock()
	defer pw_atan2_args.Unlock()

	if pw_atan2_code == 0{
		pw_atan2_code = fatbinLoad(pw_atan2_map, "pw_atan2")
	}
	...
	args := pw_atan2_args.argptr[:]
	cu.LaunchKernel(pw_atan2_code, cfg.Grid.X, cfg.Grid.Y, cfg.Grid.Z, cfg.Block.X, cfg.Block.Y, cfg.Block.Z, 0, stream0, args)
...
// maps compute capability on PTX code for pw_atan2 kernel.
var pw_atan2_map = map[int]string{ 0: "" ,
61: pw_atan2_ptx_61  }

// pw_atan2 PTX code for various compute capabilities.
const(
  pw_atan2_ptx_61 = `
.version 8.5
.target sm_61
...
.visible .entry pw_atan2(
	.param .u64 pw_atan2_param_0,
	.param .u64 pw_atan2_param_1,
	.param .u64 pw_atan2_param_2,
	.param .u32 pw_atan2_param_3
)
{
	.reg .pred 	%p<12>;
	.reg .f32 	%f<36>;
	...
	ld.param.u64 	%rd2, [pw_atan2_param_0];
	ld.param.u64 	%rd3, [pw_atan2_param_1];
	ld.param.u64 	%rd4, [pw_atan2_param_2];
	ld.param.u32 	%r2, [pw_atan2_param_3];
	mov.u32 	%r3, %ctaid.y;
	mov.u32 	%r4, %nctaid.x;
	mov.u32 	%r5, %ctaid.x;
