...
switch ( $CUDA_VERSION ) {
    ...
    #"12.2" { $CUDA_HOME = $env:CUDA_PATH_V12_2 }
...
$CCBIN = "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.42.34433\bin\Hostx86\x64"#'C:/Program Files\Microsoft Visual Studio/2022/Community/VC/Tools/MSVC/14.31.31103/bin/Hostx86/x64'
Write-Output "here"
...
$env:CC       = "C:/w64devkit/bin/gcc.exe"
$env:CGO_LDFLAGS = "-lcufft -lcurand -lcuda -L$($CUDA_HOME -replace '\\','/')/lib/x64"
$env:CGO_CFLAGS  = "-I$($CUDA_HOME -replace '\\','/')/include -w"
